...
const CONTRACT_ADDRESS = "0x420834363b741324BD13abb97bC6551675A45b99"; 
    ...
    return (
        <Container style={{ padding:"0px", border:"1px solid grey" }}>
            ...
            <Row>
                ...
                <Col style={{ "paddingRight":"0px","borderRight":"2px solid #000000" , backgroundColor:"white", "width":"100px"}}>
                    <div style={{ background: "linear-gradient(to bottom, #d4c4fb, #2E81E4)", "height":"100%",overflowY:"auto" }}>
                          <Row style={{ marginRight:"0px"}}  >
                              <Card style={{ width:'100%', alignSelf:'center', marginLeft:"15px", backgroundColor:"#00FFE8" }}>
                                <Card.Header>
                                    Chats
                                </Card.Header>
                              </Card>
                ...
                <Col xs={ 8 } style={{ "paddingLeft":"0px" }}>
                    <div style={{ "backgroundColor":"#DCDCDC", "height":"100%" }}>
                        ...
                        <Row style={{ marginRight:"0px" }}>
                              <Card style={{ width:'100%', alignSelf:'center', margin:"0 0 5px 15px" , backgroundColor:"#4046F3" }}>
                                <Card.Header>
                                    { activeChat.friendname } : { activeChat.publicKey }
                                    <Button style={{ float:"right" , border:" solid 2px" }} variant="warning" onClick={ () => {
                        ...
                        <div className="MessageBox" style={{ height:"400px", overflowY:"auto" ,  background: "linear-gradient(to bottom, #d4c4fb, #2E81E4)"}}>
                           { Messages }
                        </div>
